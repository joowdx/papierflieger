...
onMounted(() => setTheme(localStorage.theme));
</script>
    ...
    <div title="Change Theme" class="dropdown dropdown-end ">
        ...
        <div class="dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px max-h-96 h-[70vh] w-52 overflow-y-auto shadow-2xl mt-16">
            <div class="grid grid-cols-1 gap-3 p-3" tabindex="0">
                <div v-for="(theme, index) in themes" :key="index" class="overflow-hidden rounded-lg outline-base-content outline-2 outline-offset-2" :data-set-theme="theme.name" data-act-class="outline">
                    <div @click="setTheme(theme.name)" :data-theme="theme.name" class="w-full font-sans cursor-pointer bg-base-100 text-base-content">
